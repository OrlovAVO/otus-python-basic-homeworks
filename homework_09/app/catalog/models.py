...
class BookInstance(models.Model):
    ...
    borrower = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Взял')
    ...
    status = models.CharField(max_length=1, choices=LOAN_STATUS, blank=True, default='Д', help_text='Доступность книги', verbose_name='Статус:')
